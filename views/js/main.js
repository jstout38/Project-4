...
/*Optimizations added by Justin Stout:
-Refactored changePizzaSizes to take querySelectorAll outside of the for loops
-Refactored updatePositions to perform the Math function as few times as necessary instead of during every iteration of the for loop
-Compressed images
-Reduced number of pizza objects created (there were more than necessary)
-Used CSS hacks to put pizzas on their own layer
*/
...
var resizePizzas = function(size) {
  ...
  // Optimized by taking the querySelectorAll statement and the size determination out of the for loop
...
//Optimized by taking the Math.sin function outside of the for loop
function updatePositions() {
  frame++;
  window.performance.mark("mark_start_frame");
...
// Optimized by reducing from 200 to 32
